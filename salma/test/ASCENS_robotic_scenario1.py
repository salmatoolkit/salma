...
from salma.model.core import Fluent, DeterministicAction, \
    ...
    ParametricStochasticAction, Agent, Entity
...
class RoboticScenario(unittest.TestCase):
    ...
    def setUp(self):
        ...
        world.addFluent(Fluent("distance_sensor_value", "float", [("r", "robot"),("s","distance_sensor")], range=(0, 1.0)))
