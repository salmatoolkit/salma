...
class EntityTest(BaseWorldTest):
    ...
    def setUp(self):
        ...
        world.add(self.rob1, self.rob2, self.item1, self.item2)
    ...
    def test_get_agent_properties(self):
        ...
        print("rob1: x = {}, y = {}, vx = {}, vy = {}\n".format(self.rob1.xpos, self.rob1.ypos, self.rob1.vx, self.rob1.vy))
        ...
        print("rob2: x = {}, y = {}, vx = {}, vy = {}\n".format(self.rob2.xpos, self.rob2.ypos, self.rob2.vx, self.rob2.vy))
